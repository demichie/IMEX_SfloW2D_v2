...
!!$       ! we compute the integral in the log region of u_tilde(z)*alphas_rel(z), 
!!$       ! where u_tilde is u(z)/(u_avg*u_coeff*sqrt(friction_factor)) 
!!$       y = h0
!!$
...
!!$
       ...
       qc(2) = uRho_avg * r_u / mod_vel
       qc(3) = uRho_avg * r_v / mod_vel

       WRITE(*,*) 'r_h',r_h
       WRITE(*,*) 'mod_vel',mod_vel
