...
q0 = np.zeros((6+n_solid+n_add_gas,n_cells))
...
np.savetxt('exampleMIX_0000.q_2d', np.transpose(q0), fmt='%19.12e') 

with open('exampleMIX_0000.q_2d','a') as file:
    file.write('\n')
...
filedata = filedata.replace('restartfile', 'exampleMIX_0000.q_2d')
