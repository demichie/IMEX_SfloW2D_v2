...
STEP 2: create a symbolic link in the template folder to the executable

> cd templatedir
> ln -s ../../../bin/SW_VAR_DENS_MODEL .
> cd ..

STEP 3: unzip the DEM file and create a symbolic link in the templatedir/DEM folder to it
...
STEP 4: create the table for the ensamble (samples.csv)

> python create_ensemble.py

STEP 5: create the ensamble folders
...
STEP 7: create probabilistic output
